...
public class OrderController {
    ...
    public ResponseEntity<StandardResponse> getOrdersByUserId(@PathVariable Long userId) {
        try {
    ...
    public ResponseEntity<StandardResponse> placeOrderFromCart(@PathVariable Long userId) {
        try {
